...
const AllNewProduct = () => {
    ...
    const handleCategoryChange = (event) => {
      ...
      const filterFn = (product) => {
        ...
        const newMatch = product.isNew; // thêm để lọc theo sản phẩm mới
        return categoryMatch && priceMatch && occasionMatch && newMatch;
      };
    ...
    return (
        <div>
            <Header></Header>
            <Breadcrump text={"Sản phẩm mới"}></Breadcrump>
            <div style={{backgroundColor: "#FAEFEC"}}>
                ...
                <ProductList
                    ...
                    filterFn={(product) => product.isNew} // vì là sản phẩm mới nên phải lọc theo isNew để loại các sp không phải
                    title="Sản phẩm"
                    isShowAll={true}
                />
